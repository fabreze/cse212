...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: GetNextPerson dequeues a person if they have 1 turn left.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson dequeues a person with 0 turns.
    ...
    // Defect(s) Found: GetNextPerson dequeues a person with negative turns.
